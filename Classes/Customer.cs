...
namespace AutoShow.Classes
{
    public class Customer
    {
        ...
        public Customer(int kod_customer, string Sur_name, string Name, string Last_name, string passport_date,string addres, string City, int Years_old, string gender, string login_user)
        {
